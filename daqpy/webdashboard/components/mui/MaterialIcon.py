...
from ..baseprops import ComponentName, SelectorProp, StringProp, BooleanProp
from .MuiConstants import AllIcons



class MaterialIcon(MuiBaseComponent):
	"""
    IconName        : check MUI webpage - https://mui.com/material-ui/material-icons/
	...
	IconName        :  "Specify one of the icon names in given in https://mui.com/material-ui/material-icons/ and that icon with rendered."
	...
	componentName   = ComponentName     ( default = "MuiMaterialIcon",
		                                  doc = "Constant internal value for mapping classes to components in front-end" )
	IconName        = SelectorProp      ( objects = AllIcons, default = AllIcons[0], allow_None = False,
                                          doc = "Specify one of the icon names in given in https://mui.com/material-ui/material-icons/ and that icon with rendered." )
